...
from widgets.bckwidget.j3d_animation_editor.widgets.yaz0 import compress, compress_slow, compress_fast
from io import BytesIO


class JointItem(QTreeWidgetItem):
    def get_index(self):
        name = self.text(0)
...
class tree_item(QTreeWidgetItem):
    ...
    def save_animation_return(self, other_filepath="", compress_dis=1, save_all=False):
        info = j3d.fix_array(self.header_info.copy(), self.display_info)

        return j3d.sort_filepath("", info, self.sound_data)
