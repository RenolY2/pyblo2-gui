...
from widgets.bckwidget.j3d_animation_editor.widgets.yaz0 import compress
from io import BytesIO
from widgets.bckwidget.j3d_animation_editor.animations.general_animation import fix_array, sort_filepath
...
class animation_bar(QTreeWidget):
    ...
    def run_context_menu(self, pos):
        ...
        close_all_action.triggered.connect(self.emit_close_all)
